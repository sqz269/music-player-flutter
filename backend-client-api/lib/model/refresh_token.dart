...
class RefreshToken {
  ...
  @override
  String toString() => 'RefreshToken[tokenId=$tokenId, issuedTime=$issuedTime, userId=$userId, user=$user]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.issuedTime != null) {
      json[r'issuedTime'] = this.issuedTime!.toUtc().toIso8601String();
    } else {
      json[r'issuedTime'] = null;
    }
    if (this.userId != null) {
  ...
  static RefreshToken? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RefreshToken(
        ...
        issuedTime: mapDateTime(json, r'issuedTime', ''),
