...
// tests for AlbumReadDto
void main() {
  // final instance = AlbumReadDto();

  group('test AlbumReadDto', () {
    // String id
    ...
    // List<CircleReadDto> albumArtist (default value: const [])
    ...
    // List<AssetReadDto> otherFiles (default value: const [])
